...
const movieValidationSchema=yup.object({
  ...
  poster: yup.string().required("please Enter Movie Poster").min(10,"Enter bigger poster"),
  rating: yup.number().required("please Enter Movie Rating").min(1).max(10),
  summary: yup.string().required("please Enter Movie Summary").min(20,"Enter Bigger Summary"),
  trailer: yup.string().required("please Enter Movie Trailer").min(10,"Please Enter Bigger trailer")
})
